...
<head>
    <meta charset="UTF-8">
    <title>Form Pengajuan Cuti Melahirkan</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
</head>
<body>
<div class="container mt-5">
    <h3 class="mb-4">FORM PENGAJUAN CUTI MELAHIRKAN</h3>
    <form action="simpan_cuti_melahirkan.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="alasan" class="form-control" value="Cuti Melahirkan" readonly>
        </div>
        <div class="form-group">
